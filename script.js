  ...
  class Egg {
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        ...
        context.restore();
        context.stroke();
        const displayTimer = (this.hatchTimer * 0.001).toFixed(1);
  ...
  class Game {
    constructor(canvas) {
      ...
      window.addEventListener('keydown', e => {
        if (e.key.toUpperCase() === 'D') this.debug = !this.debug;
        else if (e.key.toUpperCase() === 'R') this.restart();
        else if (e.key.toUpperCase() === 'C') console.log(this.gameObjects);
        else if (e.key.toUpperCase() === 'F') this.toggleFullScreen();
      });
    }
    ...
    render(context, deltaTime) {
      ...
      if (this.score >= this.winningScore) {
        ...
        if (this.lostHatchlings <= 5) {
          message1 = "You won!"
          message2 = "You saved them all!";
        } else {
          message1 = "Next time will be better"
        ...
        context.fillText(`Final score ${this.score}. Press R start over!`, this.width * 0.5, this.height * 0.5 + 80)
        context.restore();
      }
    }
    ...
    toggleFullScreen() {
      if (!document.fullscreenElement) document.documentElement.requestFullscreen().then(r => r);
      else if (document.exitFullscreen) document.exitFullscreen().then(r => r);
    }
